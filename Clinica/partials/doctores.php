...
<div class="modal fade" style="top: -2vh !important;" id="modalDoctor" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <button style="width:20px; height:20px;" type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div id="doctorGaleria"  data-interval="false"  class="carousel slide">
  ...
  <a class="carousel-control-next" href="#doctorGaleria" data-slide="next">
