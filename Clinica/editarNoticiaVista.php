...
<table class="table-bordered" align="center" width="90%"><tr>
    ...
    <td>
     <label>Titulo</label>
      <textarea class="form-control" id="titulo" name="titulo"><?php echo $_SESSION['tituloNoticia']; ?></textarea>
     <br />
   ...
   <br /></td>
    ...
    <tr><td><input type="submit" name="Modificar" id="insert" value="Modificar" class="btn btn-success" />
     <input type=hidden class=form-control name=idNoticias id="idNoticias" value="<?php echo $_SESSION['idNoticias']; ?>"></td></tr>    
</table>
</form>
<?php
